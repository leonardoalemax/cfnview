...
export default function WinRateBar({ winPct, height = "md", fillColor }: WinRateBarProps) {
	...
	return (
		<div className={clsx("w-full rounded-full bg-base-300 overflow-hidden", trackH)}>
			<div
				className={clsx("h-full rounded-full transition-all duration-500", !fillColor && "bg-success")}
