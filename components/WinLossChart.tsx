...
interface Props {
	replays: SF6Replay[];
	userId: string; // short_id as string, e.g. "3378249682"
}
	...
	return (
		<div className='card bg-base-200 border border-base-300 mb-6'>
			<div className='card-body p-4'>
				<h2 className='card-title text-base'>Win Rate — página atual</h2>
				...
				{/* Progress bar */}
				<div className='w-full h-2 rounded-full bg-error overflow-hidden mt-1'>
					<div
