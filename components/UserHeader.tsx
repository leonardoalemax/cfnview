						...
						<div className='flex flex-wrap gap-4'>
							...
							<div>
								...
								<div className='flex items-center gap-1.5'>
									...
									<span className='font-bold'>{league.league_point.toLocaleString()} LP</span>
							...
							<div className='flex-1 min-w-[160px]'>
								...
								<p className='font-bold mb-1'>{totalPP.toLocaleString()}</p>
								{/* FG / WT / BH bar */}
								...
								<div className='flex gap-2 mt-0.5 text-[10px] text-base-content/50'>
									<span>FG {playPoint.fighting_ground.toLocaleString()}</span>
									{playPoint.world_tour > 0 && <span>WT {playPoint.world_tour.toLocaleString()}</span>}
									<span>BH {playPoint.battle_hub.toLocaleString()}</span>
								</div>
							</div>
						</div>
